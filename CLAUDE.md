...
python -m pip install -e . --no-build-isolation   # resolves aindy-runtime>=2.3.0,<3.0 from PyPI
...
CI installs the published runtime from PyPI (the pinned `aindy-runtime>=2.3.0,<3.0`
