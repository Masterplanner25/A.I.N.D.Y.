"""App-owned plugin bootstrap aggregator with degraded-mode handling.
...
This module belongs to the future apps repo. The runtime only sees it as a
plugin module name selected by the app-owned manifest.
"""
