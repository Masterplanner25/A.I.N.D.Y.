...
> **Related:** [`docs/api/API_REFERENCE.md`](./API_REFERENCE.md) documents the
...
- the future apps repo should carry app-route inventories and app-domain API
  contracts
- runtime API implementation docs now live in the separate `aindy-runtime` repo
...
Repo-split compatibility policy is defined in the runtime repo's Repo
