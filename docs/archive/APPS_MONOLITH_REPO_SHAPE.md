...
- app code imports only the runtime modules allowed by the runtime repo's
...
[Client Ownership](../operations/CLIENT_OWNERSHIP.md). For the runtime package dependency
boundary, use [Runtime Dependency](../runtime/RUNTIME_DEPENDENCY.md).
