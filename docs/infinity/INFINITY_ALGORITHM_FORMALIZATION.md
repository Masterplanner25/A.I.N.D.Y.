...
Support system (inputs, observation, feedback): `docs/infinity/INFINITY_ALGORITHM_SUPPORT_SYSTEM.md`.
...
Implemented background loops exist in `apps/tasks/services/task_service.py`:
