...
- installed runtime version: `2.23.0` (checked by **import and path** —
  ...
  `RUNTIME_2_12_0_UPGRADE.md` §1; re-checked clean on every adoption since, latest `RUNTIME_2_23_0_UPGRADE.md` §1.
...
- app-profile boot smoke on 2.23.0: `boot_profile=default-apps`, `app_plugins_loaded=True`,
  `app_plugin_count=16`
